...
export const raceConfigs = {
    ...
    "berlin-May-2025": {
        ...
        trackSvg: `
            <svg id="track-overlay" class="hyrox-track-overlay" viewBox="-100 100 800 600">
                <path id="track-path"
                    d="M 797 578 L 846 554 L 1073 526 L 1296 405 C 1308 396 1313 381 1306 371 L 1280 300 C 1276 287 1264 283 1250 286 L 837 362 C 798 370 793 351 791 335 L 791 89 C 792 74 786 69 774 66 L 674 66 C 664 66 658 72 659 86 L 656 314 C 656 335 646 351 621 350 L 209 295 C 184 289 175 292 170 303 L 130 415 C 125 427 130 437 146 443 L 300 504"
                    fill="none"
                    stroke="transparent"
                    stroke-width="5"/>
            </svg>
